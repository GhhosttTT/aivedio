...
- [ ] 4. 实现后处理服务
  ...
  - [ ]* 4.2 编写 SubtitleGenerator 单元测试和集成测试
    - 测试 SRT 文件生成
    - 测试字幕烧录
    - 测试时间轴对齐
    - _需求：8.1, 8.2, 8.3, 8.4, 8.5_
...
- [ ] 5. 实现任务编排和调度
  ...
  - [ ]* 5.2 编写 TaskOrchestrator 单元测试和集成测试
    - 测试任务链创建和调度
    - 测试任务状态查询和取消
    - 测试任务重试逻辑
    - 测试进度计算
